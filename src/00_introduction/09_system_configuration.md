...
For the complete translation layer (including the full mapping of the Abhidhamma (System Manual) to modern logic) see **[APPENDIX A: THE MASTER SYSTEM LEXICON](/src/05_back_matter/02_01_lexicon.md)** at the back of this manual.
...
* **Context:** Reality is not solid. It is a fluid stream of Voxels (3D data packets) refreshing at a finite frame rate. You are just seeing the motion blur.
