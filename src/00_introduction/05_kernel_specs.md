...
The system overheats. It is an attempt to run a static file structure on a streaming environment. The "Self" is not the User. It is a **Self Rootkit** that assumes it is the Admin.
