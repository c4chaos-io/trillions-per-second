# TPS Devlog 036: The Centaur Workflow
...
The TPS book started as a quick read manual. It was supposed to be a simple cheat sheet for tech bros and dharma geeks. But it did not stay that way. It metastasized.

What started as a single manuscript suffered massive scope creep. It grew legs, lungs, and a voice. The project is now a living, multi-format organism. We have the core manual, the narrative infographics, this very devlog, and the companion podcast. When the dust settles, there will be no traditional audiobook. Instead, there will be a complete podcast series. It will detail the full project development and provide deep-dive explorations into every chapter.

This monstrous, beautiful scope demands more than a writer sitting alone in a room. It demands a system.
Legacy writers and editors love to warn us about Generative AI. They say it turns a manuscript into unfixable porridge. They prefer their messy human spaghetti. At least the spaghetti is packed with one clear, unifying intelligence.
 ...
 * **Media Deploy:** We compile that audio and deploy it to YouTube as a TPS podcast episode.
...
![Image](/assets/infographics/TPS_IMG_CentaurWorkflowDiagram.jpg)

---

**P.P.S.** And here's a link to the X post that inspired me to write this devlog. Just turning lemons into lemonade 😅

https://x.com/c4chaos/status/2048446421398171773?s=46&t=FcKma2BPH-2Y51--ij62WA
